...
A(1:dimenstion_of_state_vector,1:dimenstion_of_state_vector)=A;
A((dimenstion_of_state_vector+1):(dimenstion_of_state_vector+dimenstion_of_output_vector),1:dimenstion_of_state_vector)=C*A;
B_a=[B;C*B];
