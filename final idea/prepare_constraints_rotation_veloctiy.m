function [velocity_constraints_A,Get_velocity_constraints_b]=prepare_constraints_rotation_veloctiy(F,H,horizon,max_angles_v)
size_f=size(F);
...
Get_velocity_constraints_b= @(x0) velocity_constraints_b_helper*x0+repmat(eye(3),2*horizon,1)*max_angles_v;
end