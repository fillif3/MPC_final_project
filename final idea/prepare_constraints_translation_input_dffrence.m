...
get_constraints_b_accelration_diff= @(u_previous) constraints_b_accelration_diff+u_previous*[ones(number_of_inputs,1);zeros((horizon-1)*number_of_inputs,1);-ones(number_of_inputs,1);zeros((horizon-1)*number_of_inputs,1);];
