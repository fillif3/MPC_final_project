function [constraints_position_A,get_position_constraints_b]=prepare_constraints_rotation_position(F,H,horizon,max_angles,min_angles)
size_f=size(F);
...
get_position_constraints_b= @(x0) position_constraints_b_helper*x0+repmat(eye(6),horizon,1)*[max_angles;-min_angles];
