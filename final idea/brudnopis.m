...
x_rotation_history=zeros(6,numberOfIterations*NumberOfIterationsOfInterloop+1);%*number_of_innerloop
...
for i=1:numberOfIterations
    ...
    U1 = norm(next_input_translation-[0;0;m*g])+0.0001;
    ref_angle_1=-asin(next_input_translation(2)/U1);
    angle_ref=[ref_angle_1;asin(next_input_translation(1)/U1/cos(ref_angle_1));0];
